    ...
    return (
        <section  className="w-full flex flex-col lg:flex-row  justify-center self-center items-center px-10">
            <div  className=" hero flex flex-col justify-center lg:ml-6">
                ...
                <h4 ref={Animation("top","30px",1000,600)} className="text-sm self-start text-[1rem] lg:text-xl lg:w-[80%] mt-5">Unlock the Code: Tamil Nadu's Largest Hackathon in collaboration with VIT Chennai and Fraternity of Young Innovators</h4>
            </div>
